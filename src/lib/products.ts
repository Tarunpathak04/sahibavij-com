...
export const products: Product[] = [
  ...
  // NLA - Gold Necklace
  {
    ...
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/NA1.webp", "/products/Necklace/NA2.webp", "/products/Necklace/NA3.webp", "/products/Necklace/NA4.webp"],
    stock_count: 6,
    is_featured: true,
    is_limited_edition: false,
  ...
  // NLB - Diamond Necklace
  {
    ...
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/NB1.webp", "/products/Necklace/NB2.webp", "/products/Necklace/NB3.webp", "/products/Necklace/NB4.webp"],
    stock_count: 4,
    is_featured: true,
    is_limited_edition: true,
  ...
  // NLC - Rose Gold Necklace
  {
    ...
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/NC1.webp", "/products/Necklace/NC2.webp", "/products/Necklace/NC3.webp", "/products/Necklace/NC4.webp"],
    stock_count: 5,
    is_featured: false,
    is_limited_edition: false,
  ...
  // NLD - Pearl Necklace
  {
    ...
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/ND1.webp", "/products/Necklace/ND2.webp", "/products/Necklace/ND3.webp", "/products/Necklace/ND4.webp"],
    stock_count: 7,
    is_featured: false,
    is_limited_edition: false,
  ...
  // NLE - Emerald Necklace
  {
    ...
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/NE1.webp", "/products/Necklace/NE2.webp", "/products/Necklace/NE3.webp", "/products/Necklace/NE4.webp"],
    stock_count: 3,
    is_featured: true,
    is_limited_edition: true,
  ...
  },
  {
    ...
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/NF1.webp", "/products/Necklace/NF2.webp", "/products/Necklace/NF3.webp", "/products/Necklace/NF4.webp"],
    stock_count: 3,
    is_featured: true,
    is_limited_edition: true,
    description: "Stunning sapphire-tone necklace with vintage charm.",
    materials: "Gold-tone finish, blue stones",
    care_info: "Wipe with soft cloth.",
  },
  {
    ...
    slug: "vintage-gold-necklace",
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/NG1.webp", "/products/Necklace/NG2.webp", "/products/Necklace/NG3.webp", "/products/Necklace/NG4.webp"],
    stock_count: 3,
    is_featured: true,
    is_limited_edition: true,
    description: "Stunning vintage gold necklace with vintage charm.",
    materials: "Micron gold polish finish",
    care_info: "Wipe with soft cloth.",
  },
  {
    ...
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/NH1.webp", "/products/Necklace/NH2.webp", "/products/Necklace/NH3.webp", "/products/Necklace/NH4.webp"],
    stock_count: 3,
    is_featured: true,
    is_limited_edition: true,
    description: "Stunning ruby-tone necklace with vintage charm.",
    materials: "Gold-tone finish, red stones",
    care_info: "Wipe with soft cloth.",
  },
  {
    ...
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/NI1.webp", "/products/Necklace/NI2.webp", "/products/Necklace/NI3.webp", "/products/Necklace/NI4.webp"],
    stock_count: 3,
    is_featured: true,
    is_limited_edition: true,
    description: "Stunning platinum-tone necklace with vintage charm.",
    materials: "Silver-tone finish",
    care_info: "Wipe with soft cloth.",
  },
  {
    id: "NLJ",
    name: "Crystal Gold Necklace",
    slug: "crystal-gold-necklace",
    price: 5000,
    category: "Necklace",
    images: ["/products/Necklace/NJ1.webp", "/products/Necklace/NJ2.webp", "/products/Necklace/NJ3.webp", "/products/Necklace/NJ4.webp"],
    stock_count: 3,
    is_featured: true,
    is_limited_edition: true,
    description: "Stunning crystal gold necklace with sparkling finish.",
    materials: "Gold-tone finish, crystals",
    care_info: "Wipe with soft cloth.",
  },
];
